...
1. In Unity, go to `Window > Graph Editor` to open the graph editor window
2. The editor will open with an empty graph view
...
3. The graph will load and display all nodes and connections
...
#### Panning
- Hold middle mouse button and drag to pan around the graph
